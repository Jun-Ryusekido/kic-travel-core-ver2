...
{"name":"氏名(日本語表記。姓と名の間に半角スペース、例:田中 太郎)","name_kana":"氏名のカタカナ読み(例:タナカ タロウ)","phone":"携帯電話番号","birthday":"生年月日(YYYY-MM-DD形式。和暦のみの記載は西暦に変換して構いません。記載が無ければnull)","age":"年齢(数値。記載が無く生年月日からも算出できなければnull)","postal_code":"郵便番号(例:150-0001。記載が無ければnull)","address":"住所(記載が無ければnull)"}
