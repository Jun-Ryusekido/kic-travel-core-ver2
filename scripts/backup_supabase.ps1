...
# ===== 緊急一時停止ガード(2026-09-12追加、2026-09-14に9-14~9-18を追加) =====
...
# 【重要】この停止期間中(9-14〜9-18)はバックアップが一切行われないため、この間に
# データ障害が発生した場合、直前の正常なバックアップ時点までしか復旧できないリスクが
# ある。あくまで一時的な緊急措置であり、9-19以降はこのガードに関係なく自動的に
# 通常通り動作する(下の$RunHoursによる時刻制限のみが適用される)。
# このブロックは一時的なものであり、9-19以降に削除してよい。
$EmergencyPauseDates = @('2026-09-12', '2026-09-13', '2026-09-14', '2026-09-15', '2026-09-16', '2026-09-17', '2026-09-18')
