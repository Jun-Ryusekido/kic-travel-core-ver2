...
//   設定・実行(PowerShell): $env:SUPABASE_SERVICE_ROLE_KEY="<値>"; node scripts/preview_cc_payment_method_migration.js
//   設定・実行(bash):       SUPABASE_SERVICE_ROLE_KEY=<値> node scripts/preview_cc_payment_method_migration.js
...
//   (SUPABASE_SERVICE_ROLE_KEY必須。anonキーでは実行できない)
